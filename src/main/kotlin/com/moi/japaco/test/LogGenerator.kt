...
class LogGenerator {
    fun generate() {
        val cr = ClassReader("com/moi/test/testReturn/TestMultiReturn")
        ...
        val file = File("D:/Codes/Java Projects/Japaco/build/classes/java/main/com/moi/test/testReturn/TestMultiReturn.class")
